...
/// [MS-WMF] 2.3.6.22 GETPRINTINGOFFSET Record
/// The GETPRINTINGOFFSET Record retrieves the offset from the upper-left corner of the physical page where the actual
/// printing or drawing begins.
/// See section 2.3.6 for the specification of other Escape Record Types.
public struct GETPRINTINGOFFSET {
    ...
    public init(dataStream: inout DataStream) throws {
        ...
        /// EscapeFunction (2 bytes): A 16-bit unsigned integer that defines the escape function. The value MUST be 0x000D
        /// (GETPRINTINGOFFSET) from the MetafileEscapes Enumeration (section 2.1.1.17) table.
        self.escapeFunction = try MetafileEscapes(dataStream: &dataStream)
        guard self.escapeFunction == .GETPRINTINGOFFSET else {
            throw WmfReadError.corrupted
        }
